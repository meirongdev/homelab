...
> **⚠️ 2026-07-11 更新**: Calibre 书库已从 NFS 迁移至 `local-path`（见 [2026-07-06-storage-local-migration-and-backup-redesign.md](../2026-07-06-storage-local-migration-and-backup-redesign.md)），上述 NFS `all_squash` 配置对当前运行时已不再适用，仅保留作历史记录。
