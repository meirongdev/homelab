...
> - **Recommendation #5** ("keep oracle-k3s outside ArgoCD") was overtaken by the [oracle-k3s GitOps migration](../2026-06-04-oracle-k3s-argocd-gitops.md) completed on 2026-06-04.
