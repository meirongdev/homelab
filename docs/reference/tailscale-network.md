...
| `k8s-worker-106` (100.74.162.97) | **nothing** | 同上，理由更直接：它就在 `192.168.50.0/24` 上，而 pve 正是该段的 subnet router（2026-08-13 入编，[ADR](../decisions/storage106-as-homelab-worker.md)） |
