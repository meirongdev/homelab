...
4. **Future SSO**: if shared sign-in is reintroduced, prefer native OIDC or per-app reverse-proxy auth instead of reviving controller-specific ForwardAuth. See `docs/plans/security/2026-03-08-cilium-zitadel-sso-plan.md`.
