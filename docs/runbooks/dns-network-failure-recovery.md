...
```bash
ssh -i ~/.ssh/vgio root@100.94.186.7
```
...
```bash
kubectl config set-cluster k3s-homelab --server=https://100.94.186.7:6443
```

If TLS error (`x509: certificate is not valid for 100.94.186.7`):
